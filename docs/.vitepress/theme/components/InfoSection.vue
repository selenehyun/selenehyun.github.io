    ...
    >
      ...
      >
        ...
        <a
          ...
          class="inline-flex items-center gap-1.5 px-4 py-2.5 bg-black hover:bg-gray-800 text-white rounded-full text-[0.8125rem] font-medium transition-all duration-200"
        >
